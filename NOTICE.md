WA Robotics Scout uses some code from the push-messaging-and-notifications subdirectory of the GoogleChrome/samples repo
on GitHub, and from the Google Develoeprs Web Fundamentals site (https://developers.google.com/web/fundamentals/).
The ChromeSamples repositroy and aforementioned website (Google Developers Web Fundamentals) are licensed under the Apache License 2.0, which is included below:
